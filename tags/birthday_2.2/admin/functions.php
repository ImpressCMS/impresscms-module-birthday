...
function birthday_adminMenu($currentoption = 0, $breadcrumb = '')
{
	...
	if(file_exists(XOOPS_ROOT_PATH.'/modules/birthday/language/'.$xoopsConfig['language'].'/modinfo.php')) {
		include_once XOOPS_ROOT_PATH.'/modules/birthday/language/'.$xoopsConfig['language'].'/modinfo.php';
	} else {
		include_once XOOPS_ROOT_PATH.'/modules/birthday/language/english/modinfo.php';
	}
	global $adminmenu;
	include 'menu.php';
