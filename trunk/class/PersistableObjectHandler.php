...
class Birthday_Object extends XoopsObject
{
 ...
 */
class Birthday_XoopsPersistableObjectHandler extends XoopsObjectHandler {
    ...
    */
    function __construct(&$db, $tablename, $classname, $keyname, $idenfierName = '', $cacheOptions=null) {
        ...
        if(is_null($cacheOptions)) {
        	$this->setCachingOptions(array('cacheDir' => XOOPS_UPLOAD_PATH.'/birthday/', 'lifeTime' => null, 'automaticSerialization' => true, 'fileNameProtection' => false));
        } else {
    ...
    function &getObjects($criteria = null, $id_as_key = false, $as_object = true, $fields = '*', $autoSort = true)
    {
        ...
        $Cache_Lite = new birthday_Cache_Lite($this->cacheOptions);
