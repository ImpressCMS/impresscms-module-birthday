...
function birthday_adminMenu($currentoption = 0, $breadcrumb = '')
{
	global $xoopsConfig, $xoopsModule;
	if(file_exists(ICMS_ROOT_PATH.'/modules/birthday/language/'.$xoopsConfig['language'].'/modinfo.php')) {
		include_once ICMS_ROOT_PATH.'/modules/birthday/language/'.$xoopsConfig['language'].'/modinfo.php';
	} else {
		include_once ICMS_ROOT_PATH.'/modules/birthday/language/english/modinfo.php';
	}
	global $adminmenu;
	include 'menu.php';
	...
	echo "<a href=\"../index.php\">"._AM_BIRTHDAY_GO_TO_MODULE."</a> | <a href=\"".ICMS_URL."/modules/system/admin.php?fct=preferences&amp;op=showmod&amp;mod=".$xoopsModule->getVar('mid')."\">"._AM_BIRTHDAY_PREFERENCES."</a> | <a href='index.php?op=maintain'>"._AM_BIRTHDAY_MAINTAIN."</a>\n";
	echo "</td>\n";
	...
	foreach($GLOBALS['adminmenu'] as $key=>$link) {
		...
		echo "<a href=\"".ICMS_URL."/modules/birthday/".$link['link']."\"><span>".$link['title']."</span></a>\n";
		echo "</li>\n";
	}
	echo "</ul>\n";
	echo "</div>\n";
