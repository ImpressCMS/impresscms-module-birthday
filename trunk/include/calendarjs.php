...
require_once ICMS_ROOT_PATH.'/language/'.$GLOBALS['xoopsConfig']['language'].'/calendar.php';
?>
<link rel="stylesheet" type="text/css" media="all" href="<?php echo ICMS_URL;?>/include/calendar-blue.css" />
<script type="text/javascript" src="<?php echo ICMS_URL.'/include/calendar.js';?>"></script>
